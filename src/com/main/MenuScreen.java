                ...
                if (!isValidId) {
                    ...
                    if (!isValidPass) {
                        ...
                        while (true) {
                            ...
                            int librarianInput;
                            try {
                    			librarianInput = loginChoice.nextInt();
                    			}
                    			catch (Exception e){
                                    loginChoice.next();
                                    System.out.println("Invalid input...Exiting");
                            ...
                            switch (librarianInput) {
                                ...
                                case 4:
                                	while(true){
                						...
                						int eventInput;
                						try {
                                			eventInput = loginChoice.nextInt();
                                			}
                                			catch (Exception e){
                                                loginChoice.next();
                                                System.out.println("Invalid input...Exiting");
            					...
            					case 5:
            						while(true) {
            							...
            							int requestChoice;
            							try {
                                			requestChoice = loginChoice.nextInt();
                                			}
                                			catch (Exception e){
                                                loginChoice.next();
                                                System.out.println("Invalid input...Exiting");
            							...
            							if(requestChoice==1) {
            				        		...
            				        		try {
            				        			id = loginChoice.nextInt();
            				        			}
            				        			catch (Exception e){
            				                        loginChoice.next();
            				                        System.out.println("Invalid Input...Returning to librarian menu");
            				                        break;
            				        			}
            								loginChoice.nextLine();
            			...
            			break;
                                ...
                                case 6: // 6. Reserve a room
                                    while(true) {
                                        ...
                                        RoomUtility rutil = new RoomUtility();
                                       isValidId = rutil.validateRoomId(db.checkFreeRooms(), roomId);
                                        if(!isValidId) {
                                ...
                                case 8: //Checkout a book or video
                                    ...
                                    if (availBooks.isEmpty() && availVideos.isEmpty()) {
                                        ...
                                        if (isValidCallNum == -1 || isValidCallNum == 3) {
                                            ...
                                            System.out.println("Book Checked Out and is due on: " + dueDate);                                            break;
                                            ...
                                            System.out.println("Video Checked Out and is due on: " + dueDate);                                            break;
                                        }
                                    }
                                    break;
                                default:
